...
.controller('View1Ctrl', ['$scope', 'View1Factory', function($scope, View1Factory) {
	...
	$scope.search = function() {
		...
		var results = View1Factory.getResults($scope.choice, $scope.state_select['code']);//trusting the results here isn't super robust, but is probably sufficient for this exercise
